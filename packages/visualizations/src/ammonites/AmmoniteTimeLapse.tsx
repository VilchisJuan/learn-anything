...
// Diversity arc per period: rough 0–100 values for the wave
const DIVERSITY = [20, 45, 15, 70, 100, 75];

const TOTAL_MA = 419 - 66; // 353 Ma
  ...
  return (
    <div className="my-8 rounded-xl border border-border bg-[#111] overflow-hidden select-none">
      ...
      <div className="px-5 py-4 border-b border-border">
        ...
        <p className="text-xs text-muted-foreground mt-0.5">Each band is proportional to its real duration — click a period to explore</p>
      </div>
      ...
      <div className="p-5 flex flex-col gap-3">
        ...
        <AnimatePresence mode="wait">
          {activePeriod ? (
              ...
              <div className="flex-1 min-w-0">
                <div className="flex flex-wrap items-center gap-x-2 gap-y-1 mb-1.5">
                  ...
                  <span
                    ...
                    style={{
                      color: activePeriod.badgeColor,
                      backgroundColor: activePeriod.badgeColor + "20",
                    }}
                  >
                    {activePeriod.badge}
                  </span>
            ...
            >
              Click any period to see what happened
            </motion.p>
          )}
        </AnimatePresence>
      </div>
