...
export const NAV_AREAS: NavArea[] = [
  {
    ...
    topics: [
      ...
      },
      {
        ...
        label: "APIs",
        level: "beginner",
        description: "Everything a junior developer needs to know — HTTP, REST, auth, security, patterns, and production concerns.",
        subtopics: [
          { id: "introduction", label: "Introduction", level: "beginner" },
          { id: "http-fundamentals", label: "HTTP Fundamentals", level: "beginner" },
          { id: "rest-design", label: "REST Design", level: "beginner" },
          { id: "authentication", label: "Authentication", level: "intermediate" },
          { id: "authorization", label: "Authorization", level: "intermediate" },
          { id: "security", label: "Security", level: "intermediate" },
          { id: "design-patterns", label: "Design Patterns", level: "intermediate" },
          { id: "multi-tenancy", label: "Multi-Tenancy", level: "intermediate" },
          { id: "error-handling", label: "Error Handling", level: "beginner" },
          { id: "caching", label: "Caching", level: "intermediate" },
          { id: "connection-methods", label: "Connection Methods", level: "intermediate" },
          { id: "middleware", label: "Middleware", level: "intermediate" },
          { id: "api-gateway", label: "API Gateway", level: "intermediate" },
          { id: "versioning", label: "Versioning", level: "beginner" },
          { id: "documentation", label: "Documentation", level: "beginner" },
